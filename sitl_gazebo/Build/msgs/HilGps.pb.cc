...
void protobuf_AssignDesc_HilGps_2eproto() {
  ...
  HilGps_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(HilGps, _unknown_fields_),
      -1,
...
::google::protobuf::uint8* HilGps::SerializeWithCachedSizesToArray(
...
void HilGps::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const HilGps* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const HilGps*>(
      &from);
  if (source == NULL) {
